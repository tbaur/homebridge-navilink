...
export const PLUGIN_NAME = 'homebridge-navilink'

/** Platform alias used in `config.json` and `config.schema.json`. */
export const PLATFORM_NAME = 'NaviLink'
 ...
 */
export const UUID_PREFIX = 'homebridge-navilink:'
...
export const MANUFACTURER = 'Navien'

/** Model shown when the cloud does not name one. */
export const DEFAULT_MODEL = 'NaviLink appliance'
 ...
 */
export const API_BASE = 'https://nlus.naviensmartcontrol.com/api/v2'

/** AWS IoT data endpoint for the same stack, and the region that signs it. */
export const IOT_ENDPOINT = 'a1t30mldyslmuq-ats.iot.us-east-1.amazonaws.com'

/** @see IOT_ENDPOINT */
export const IOT_REGION = 'us-east-1'
...
export const MAX_REST_BYTES = 262_144
...
export const MQTT_SUBSCRIBE_TIMEOUT_MS = 10_000
 ...
 * an answer is coming.
 */
export const STATUS_RESPONSE_TIMEOUT_MS = 20_000
 ...
 */
export const MQTT_KEEPALIVE_SEC = 30
 ...
 */
export const MQTT_PING_TIMEOUT_MS = 10_000
 ...
 * matters.
 */
export const DEFAULT_STATUS_INTERVAL_SEC = 120

/** Shortest configurable status interval. */
export const MIN_STATUS_INTERVAL_SEC = 30
 ...
 */
export const CREDENTIAL_REFRESH_MARGIN_MS = 300_000
 ...
 */
export const UNREACHABLE_REWARN_MS = 60 * 60 * 1_000
...
export const CONTROL_RATE_LIMIT_MS = 1_000
 ...
 */
export const CONTROL_INTERVAL_FAIL_CODE = 2
 ...
 */
export const CONTROL_LOCKOUT_MS = 30_000
 ...
 */
export const SETPOINT_COALESCE_MS = 800
 ...
 */
export const STALE_OBSERVATION_INTERVALS = 3
