 ...
 */
export declare const ACCESSORY_KINDS: readonly ["dhw", "heating", "power", "recirculation", "fault", "outdoor", "dhwOutlet", "dhwInlet", "heatSupply", "heatReturn"];
/** @see ACCESSORY_KINDS */
...
export declare const PROBE_KINDS: readonly ["outdoor", "dhwOutlet", "dhwInlet", "heatSupply", "heatReturn"];
/** @see PROBE_KINDS */
export type ProbeKind = (typeof PROBE_KINDS)[number];
/** Narrow an {@link AccessoryKind} to one of the temperature probes. */
export declare function isProbeKind(value: AccessoryKind): value is ProbeKind;
/**
 ...
 */
export declare const APPLIANCE_FAMILIES: readonly ["NPE", "NCB", "NHB", "CAS_NPE", "CAS_NHB", "NFB", "CAS_NFB", "NFC", "NPN", "CAS_NPN", "NPE2", "CAS_NPE2", "NCB_H", "NVW", "CAS_NVW", "UNKNOWN"];
