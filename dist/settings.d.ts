...
export declare const PLUGIN_NAME = "homebridge-navilink";
/** Platform alias used in `config.json` and `config.schema.json`. */
export declare const PLATFORM_NAME = "NaviLink";
/**
 ...
 */
export declare const UUID_PREFIX = "homebridge-navilink:";
...
export declare const MANUFACTURER = "Navien";
/** Model shown when the cloud does not name one. */
export declare const DEFAULT_MODEL = "NaviLink appliance";
/**
 ...
 */
export declare const API_BASE = "https://nlus.naviensmartcontrol.com/api/v2";
/** AWS IoT data endpoint for the same stack, and the region that signs it. */
export declare const IOT_ENDPOINT = "a1t30mldyslmuq-ats.iot.us-east-1.amazonaws.com";
/** @see IOT_ENDPOINT */
export declare const IOT_REGION = "us-east-1";
 ...
 * an answer is coming.
 */
export declare const STATUS_RESPONSE_TIMEOUT_MS = 20000;
/**
 * MQTT keepalive.
 *
 ...
 */
export declare const MQTT_KEEPALIVE_SEC = 30;
/**
 ...
 */
export declare const MQTT_PING_TIMEOUT_MS = 10000;
/** First reconnect delay after a dropped session. Doubles up to the ceiling. */
export declare const RECONNECT_BACKOFF_BASE_MS = 2000;
/**
 ...
 */
export declare const RECONNECT_BACKOFF_MAX_MS = 300000;
/**
 ...
 * matters.
 */
export declare const DEFAULT_STATUS_INTERVAL_SEC = 120;
/** Shortest configurable status interval. */
export declare const MIN_STATUS_INTERVAL_SEC = 30;
/** Longest configurable status interval. */
export declare const MAX_STATUS_INTERVAL_SEC = 3600;
/**
 ...
 */
export declare const DEFAULT_DIAGNOSTICS_INTERVAL_SEC = 0;
...
export declare const MAX_DIAGNOSTICS_INTERVAL_SEC = 3600;
/**
 ...
 */
export declare const MQTT_DOWN_GRACE_SEC = 60;
/**
 ...
 */
export declare const CREDENTIAL_REFRESH_MARGIN_MS = 300000;
/**
 ...
 */
export declare const MIN_REFRESH_DELAY_MS = 60000;
/**
 ...
 */
export declare const UNREACHABLE_REWARN_MS: number;
/**
 ...
 */
export declare const DISCOVERY_BUDGET_MS = 45000;
/** Minimum gap between two control commands to one appliance. */
export declare const CONTROL_RATE_LIMIT_MS = 1000;
/**
 ...
 */
export declare const CONTROL_INTERVAL_FAIL_CODE = 2;
/**
 ...
 */
export declare const CONTROL_LOCKOUT_MS = 30000;
/**
 ...
 */
export declare const SETPOINT_COALESCE_MS = 800;
/**
 ...
 */
export declare const STALE_OBSERVATION_INTERVALS = 3;
/** Lowest channel number on a gateway. */
export declare const MIN_CHANNEL = 1;
/**
