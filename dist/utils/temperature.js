...
exports.HOMEKIT_TEMPERATURE_STEP = exports.TEMPERATURE_TYPE_FAHRENHEIT = exports.TEMPERATURE_TYPE_CELSIUS = void 0;
exports.scaleFromTemperatureType = scaleFromTemperatureType;
exports.decodeWireTemperature = decodeWireTemperature;
exports.encodeWireTemperature = encodeWireTemperature;
exports.nativeToCelsius = nativeToCelsius;
exports.celsiusToNative = celsiusToNative;
exports.resolveSetpoint = resolveSetpoint;
exports.isUsableRange = isUsableRange;
 ...
 */
exports.TEMPERATURE_TYPE_CELSIUS = 1;
/** @see TEMPERATURE_TYPE_CELSIUS */
exports.TEMPERATURE_TYPE_FAHRENHEIT = 2;
/**
 ...
 */
exports.HOMEKIT_TEMPERATURE_STEP = 0.5;
/** Read `temperatureType` from a `channelinfo` frame. Undefined when unknown. */
function scaleFromTemperatureType(value) {
    if (value === exports.TEMPERATURE_TYPE_CELSIUS) {
        return 'celsius';
    }
    if (value === exports.TEMPERATURE_TYPE_FAHRENHEIT) {
        return 'fahrenheit';
    }
    return undefined;
}
 ...
 */
function decodeWireTemperature(raw, scale) {
 ...
 * be hidden in here.
 */
function resolveSetpoint(input) {
 ...
 */
function isUsableRange(min, max) {
...
function formatNative(value, scale) {
