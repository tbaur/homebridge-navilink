 ...
 */
export declare const TEMPERATURE_TYPE_CELSIUS = 1;
/** @see TEMPERATURE_TYPE_CELSIUS */
export declare const TEMPERATURE_TYPE_FAHRENHEIT = 2;
/**
 ...
 */
export declare const HOMEKIT_TEMPERATURE_STEP = 0.5;
/** Read `temperatureType` from a `channelinfo` frame. Undefined when unknown. */
export declare function scaleFromTemperatureType(value: unknown): TemperatureScale | undefined;
/**
 ...
 */
export declare function decodeWireTemperature(raw: unknown, scale: TemperatureScale): number | undefined;
/**
 ...
 */
export declare function encodeWireTemperature(native: number, scale: TemperatureScale): number;
/** Convert a native reading to the Celsius HomeKit expects. */
export declare function nativeToCelsius(native: number, scale: TemperatureScale): number;
/** Convert a Celsius value from HomeKit to the appliance's native scale. */
export declare function celsiusToNative(celsius: number, scale: TemperatureScale): number;
/**
 ...
 * be hidden in here.
 */
export declare function resolveSetpoint(input: {
    celsius: number;
 ...
 */
export declare function isUsableRange(min: number | undefined, max: number | undefined): boolean;
...
export declare function formatNative(value: number, scale: TemperatureScale): string;
